...
@StringRes
fun Story.toShortcutShortLabelStringId(): Int = when (this) {
...
@StringRes
fun Story.toShortcutLongLabelStringId(): Int = when (this) {
...
@DrawableRes
fun Story.toShortcutIconDrawableId(): Int = when (this) {
